...
class ElectionsControllerTest < ActionController::TestCase
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post :create, election: { contact: @election.contact, description: @election.description, end: @election.end, owner: @election.owner, start: @election.start, title: @election.title, updid: @election.updid }
    end
  ...
  test "should update election" do
    put :update, id: @election, election: { contact: @election.contact, description: @election.description, end: @election.end, owner: @election.owner, start: @election.start, title: @election.title, updid: @election.updid }
    assert_redirected_to election_path(assigns(:election))
  end
